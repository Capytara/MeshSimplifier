...
// 	typename T::TetraPointer & VTp( const int ) { static typename T::TetraPointer both_count_=0; return both_count_; }
// 	typename T::TetraPointer const cVTp( const int ) const { static typename T::TetraPointer const both_count_=0; return both_count_; }
// 	typename T::TetraPointer & TTp( const int ) { static typename T::TetraPointer both_count_=0; return both_count_; }
// 	typename T::TetraPointer const cTTp( const int ) const { static typename T::TetraPointer const both_count_=0; return both_count_; }
